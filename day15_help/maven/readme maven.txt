...
OPen source tool
Version -- 3.x
It's bundled as a plug-in within eclipse IDE(m2e)
...
9. scope  --	defines scope of dependency  for this maven project. It can be compile, provided, runtime, test and system.
...
A maven repository is a directory of packaged JAR file, declared  with pom.xml file. Maven searches for dependencies(JARs) in the repositories. There are 3 types of maven repository:
